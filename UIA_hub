...
local v56 = v16.Player:AddSection("Miscellaneous");
...
local v56 = v16.Shop:AddSection("Miscellaneous");
v16.Shop:AddButton({
    Title = "Đổi Stats",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("Miscellaneous");
...
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "Bay Đến Cửa Trial Race Draco",
    Description = "",
    Default = false
});
